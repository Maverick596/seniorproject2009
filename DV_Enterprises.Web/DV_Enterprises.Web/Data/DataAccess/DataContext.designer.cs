...
namespace DV_Enterprises.Web.Data.DataAccess.SqlRepository
{
    ...
    partial void OnLastActivityDateChanged();
		...
		[Association(Name="User_Preset", Storage="_dvent_Presets", ThisKey="UserId", OtherKey="UserID")]
    ...
    partial void OnNameChanged();
		...
		[Association(Name="TaskType_Task", Storage="_dvent_Tasks", ThisKey="TaskTypeId", OtherKey="TaskTypeID")]
    ...
    partial void OnDateUpdatedChanged();
		...
		[Association(Name="Section_Task", Storage="_dvent_Tasks", ThisKey="SectionID", OtherKey="SectionID")]
		public EntitySet<Task> Tasks
		{
			get
			{
		...
		[Association(Name="Preset_Section", Storage="_dvent_Preset", ThisKey="PresetID", OtherKey="PresetID", IsForeignKey=true)]
