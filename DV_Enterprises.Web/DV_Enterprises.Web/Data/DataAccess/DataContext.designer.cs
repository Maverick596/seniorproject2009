...
namespace DV_Enterprises.Web.Data.DataAccess.SqlRepository
{
	...
	public partial class Section : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private bool _IsTemperatureActivated;
    ...
    partial void OnNameChanging(string value);
    partial void OnNameChanged();
    partial void OnIsTemperatureActivatedChanging(bool value);
    partial void OnIsTemperatureActivatedChanged();
    partial void OnIdealTemperatureChanging(System.Nullable<int> value);
    partial void OnIdealTemperatureChanged();
    partial void OnTemperatureThresholdChanging(System.Nullable<int> value);
    partial void OnTemperatureThresholdChanged();
    ...
    partial void OnDateUpdatedChanged();
		...
		[Column(Storage="_IsTemperatureActivated", DbType="Bit NOT NULL")]
		public bool IsTemperatureActivated
		{
			get
			{
				return this._IsTemperatureActivated;
			}
			set
			{
				if ((this._IsTemperatureActivated != value))
				{
					this.OnIsTemperatureActivatedChanging(value);
					this.SendPropertyChanging();
					this._IsTemperatureActivated = value;
					this.SendPropertyChanged("IsTemperatureActivated");
					this.OnIsTemperatureActivatedChanged();
				}
			}
		}
