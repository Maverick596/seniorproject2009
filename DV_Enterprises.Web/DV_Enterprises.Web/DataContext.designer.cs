...
namespace DV_Enterprises.Web.BLL
{
    ...
    partial void OnDateDeletedChanged();
		...
		[Association(Name="Crop_Environment", Storage="_Environments", OtherKey="CropId")]
    ...
    partial void OnSectionIdChanged();
		...
		[Association(Name="Section_SectionLog", Storage="_Section", ThisKey="SectionId", IsForeignKey=true)]
    ...
    partial void OnDateDeletedChanged();
		...
		[Association(Name="Environment_Schedule", Storage="_Schedules", OtherKey="EnviromentId")]
		...
		[Association(Name="Environment_Section", Storage="_Sections", OtherKey="EnviromentId")]
		...
		[Association(Name="Crop_Environment", Storage="_Crop", ThisKey="CropId", IsForeignKey=true)]
		public Crop Crop
		{
			get
			{
    ...
    partial void OnLocationIdChanged();
		...
		[Association(Name="Location_Greenhouse", Storage="_Location", ThisKey="LocationId", IsForeignKey=true)]
    ...
    partial void OnDateDeletedChanged();
		...
		[Association(Name="Environment_Schedule", Storage="_Environment", ThisKey="EnviromentId", IsForeignKey=true)]
		...
		[Association(Name="ScheduleType_Schedule", Storage="_ScheduleType", ThisKey="ScheduleTypeId", IsForeignKey=true)]
    ...
    partial void OnnameChanged();
		...
		[Association(Name="ScheduleType_Schedule", Storage="_Schedules", OtherKey="ScheduleTypeId")]
		public EntitySet<Schedule> Schedules
		{
			get
			{
    ...
    partial void OnHeightChanged();
		...
		[Association(Name="Section_SectionLog", Storage="_SectionLogs", OtherKey="SectionId")]
		...
		[Association(Name="Environment_Section", Storage="_Environment", ThisKey="EnviromentId", IsForeignKey=true)]
		public Environment Environment
		{
			get
			{
    ...
    partial void OnCountryChanged();
		...
		[Association(Name="Location_Greenhouse", Storage="_Greenhouses", OtherKey="LocationId")]
	...
	public partial class Customer
	{
		...
		[Column(Storage="_Address1", CanBeNull=false)]
		...
		[Column(Storage="_Address2", CanBeNull=false)]
		...
		[Column(Storage="_AddedBy", CanBeNull=false)]
		...
		[Column(Storage="_ModifiedBy", CanBeNull=false)]
