...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_SectionUser]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_SectionUser](
	[SectionUserId] [int] IDENTITY(1,1) NOT NULL,
 CONSTRAINT [PK_dvent_SectionUser] PRIMARY KEY CLUSTERED 
(
	[SectionUserId] ASC
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_SectionLog]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_SectionLog](
	[SectionLogID] [int] NOT NULL,
	[Time] [timestamp] NOT NULL,
	[Temperature] [int] NOT NULL,
	[Humidity] [int] NOT NULL,
	[isLightOn] [bit] NOT NULL,
	[SectionId] [int] NOT NULL,
 CONSTRAINT [PK_dvent_SectionLog] PRIMARY KEY CLUSTERED 
(
	[SectionLogID] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_TaskType]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_TaskType](
	[TaskTypeId] [int] IDENTITY(1,1) NOT NULL,
	[Name] [nvarchar](253) NOT NULL,
 CONSTRAINT [PK_dvent_ScheduleType] PRIMARY KEY CLUSTERED 
(
	[TaskTypeId] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_Product]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_Product](
 ...
 CONSTRAINT [PK_dvent_Product] PRIMARY KEY CLUSTERED 
(
	[ProductID] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_OrderItem]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_OrderItem](
	[OrderItemId] [int] NOT NULL,
	[Price] [decimal](18, 2) NOT NULL,
	[Qty] [int] NULL,
 CONSTRAINT [PK_dvent_OrderItem] PRIMARY KEY CLUSTERED 
(
	[OrderItemId] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_Order]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_Order](
	[OrderId] [int] NOT NULL,
	[SubTotal] [decimal](18, 2) NULL,
	[ShippingCost] [decimal](18, 2) NULL,
 CONSTRAINT [PK_dvent_Order] PRIMARY KEY CLUSTERED 
(
	[OrderId] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_Greenhouse]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_Greenhouse](
	[GreenhouseID] [int] IDENTITY(1,1) NOT NULL,
	[City] [nvarchar](255) NOT NULL,
	[StateOrProvince] [nvarchar](50) NOT NULL,
	[StreetLine1] [nvarchar](255) NOT NULL,
	[StreetLine2] [nvarchar](255) NULL,
	[Zip] [int] NULL,
	[Country] [nvarchar](255) NOT NULL,
	[IsDefault] [bit] NOT NULL,
	[DateCreated] [datetime] NOT NULL,
	[DateUpdated] [datetime] NOT NULL,
 CONSTRAINT [PK_dvent_Greenhouse] PRIMARY KEY CLUSTERED 
(
	[GreenhouseID] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_Address]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_Address](
	...
	[IsDefault] [bit] NOT NULL,
	[DateCreated] [datetime] NOT NULL,
	[DateUpdated] [nchar](10) NOT NULL,
 CONSTRAINT [PK_dvent_Location] PRIMARY KEY CLUSTERED 
(
	[AddressID] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_Task]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_Task](
	...
	[DateCreated] [datetime] NOT NULL,
	[DateUpdated] [datetime] NOT NULL,
 CONSTRAINT [PK_dvent_Schedule] PRIMARY KEY CLUSTERED 
(
	[TaskID] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_Section]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_Section](
	[SectionID] [int] IDENTITY(1,1) NOT NULL,
	[GreenhouseID] [int] NOT NULL,
	[Name] [nvarchar](255) NOT NULL,
	[IsTemeratureActivated] [bit] NULL,
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_GreenhouseUser]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_GreenhouseUser](
	[GreenhouseUserId] [int] IDENTITY(1,1) NOT NULL,
	[UserId] [uniqueidentifier] NOT NULL,
	[GreenhouseId] [int] NOT NULL,
	[IsAdmin] [bit] NOT NULL,
	[IsApproved] [bit] NOT NULL,
 CONSTRAINT [PK_dvent_GreenhouseUser] PRIMARY KEY CLUSTERED 
(
	[GreenhouseUserId] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dvent_Preset]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[dvent_Preset](
	...
	[TemperatureThreshold] [int] NULL,
	[IdealLightIntensity] [int] NULL,
	[LightIntensityTreshold] [int] NULL,
	[IdealHumidity] [int] NULL,
	[HumidityThreshold] [int] NULL,
	[DateCreated] [datetime] NOT NULL,
	[DateUpdated] [datetime] NOT NULL,
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_dvent_Task_dvent_Section]') AND parent_object_id = OBJECT_ID(N'[dbo].[dvent_Task]'))
ALTER TABLE [dbo].[dvent_Task]  WITH CHECK ADD  CONSTRAINT [FK_dvent_Task_dvent_Section] FOREIGN KEY([SectionID])
REFERENCES [dbo].[dvent_Section] ([SectionID])
GO
ALTER TABLE [dbo].[dvent_Task] CHECK CONSTRAINT [FK_dvent_Task_dvent_Section]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_dvent_Task_dvent_TaskType]') AND parent_object_id = OBJECT_ID(N'[dbo].[dvent_Task]'))
ALTER TABLE [dbo].[dvent_Task]  WITH CHECK ADD  CONSTRAINT [FK_dvent_Task_dvent_TaskType] FOREIGN KEY([TaskTypeID])
REFERENCES [dbo].[dvent_TaskType] ([TaskTypeId])
GO
ALTER TABLE [dbo].[dvent_Task] CHECK CONSTRAINT [FK_dvent_Task_dvent_TaskType]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_dvent_Section_aspnet_Users]') AND parent_object_id = OBJECT_ID(N'[dbo].[dvent_Section]'))
ALTER TABLE [dbo].[dvent_Section]  WITH CHECK ADD  CONSTRAINT [FK_dvent_Section_aspnet_Users] FOREIGN KEY([UserID])
REFERENCES [dbo].[aspnet_Users] ([UserId])
GO
ALTER TABLE [dbo].[dvent_Section] CHECK CONSTRAINT [FK_dvent_Section_aspnet_Users]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_dvent_Section_dvent_Greenhouse]') AND parent_object_id = OBJECT_ID(N'[dbo].[dvent_Section]'))
ALTER TABLE [dbo].[dvent_Section]  WITH CHECK ADD  CONSTRAINT [FK_dvent_Section_dvent_Greenhouse] FOREIGN KEY([GreenhouseID])
REFERENCES [dbo].[dvent_Greenhouse] ([GreenhouseID])
GO
ALTER TABLE [dbo].[dvent_Section] CHECK CONSTRAINT [FK_dvent_Section_dvent_Greenhouse]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_dvent_Section_dvent_Preset]') AND parent_object_id = OBJECT_ID(N'[dbo].[dvent_Section]'))
ALTER TABLE [dbo].[dvent_Section]  WITH CHECK ADD  CONSTRAINT [FK_dvent_Section_dvent_Preset] FOREIGN KEY([PresetID])
REFERENCES [dbo].[dvent_Preset] ([PresetID])
GO
ALTER TABLE [dbo].[dvent_Section] CHECK CONSTRAINT [FK_dvent_Section_dvent_Preset]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_dvent_GreenhouseUser_aspnet_Users]') AND parent_object_id = OBJECT_ID(N'[dbo].[dvent_GreenhouseUser]'))
ALTER TABLE [dbo].[dvent_GreenhouseUser]  WITH CHECK ADD  CONSTRAINT [FK_dvent_GreenhouseUser_aspnet_Users] FOREIGN KEY([UserId])
REFERENCES [dbo].[aspnet_Users] ([UserId])
GO
ALTER TABLE [dbo].[dvent_GreenhouseUser] CHECK CONSTRAINT [FK_dvent_GreenhouseUser_aspnet_Users]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_dvent_GreenhouseUser_dvent_Greenhouse]') AND parent_object_id = OBJECT_ID(N'[dbo].[dvent_GreenhouseUser]'))
ALTER TABLE [dbo].[dvent_GreenhouseUser]  WITH CHECK ADD  CONSTRAINT [FK_dvent_GreenhouseUser_dvent_Greenhouse] FOREIGN KEY([GreenhouseId])
REFERENCES [dbo].[dvent_Greenhouse] ([GreenhouseID])
GO
ALTER TABLE [dbo].[dvent_GreenhouseUser] CHECK CONSTRAINT [FK_dvent_GreenhouseUser_dvent_Greenhouse]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Pa__Appli__73C51D7B]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_Paths]'))
ALTER TABLE [dbo].[aspnet_Paths]  WITH CHECK ADD FOREIGN KEY([ApplicationId])
REFERENCES [dbo].[aspnet_Applications] ([ApplicationId])
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Ro__Appli__74B941B4]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_Roles]'))
ALTER TABLE [dbo].[aspnet_Roles]  WITH CHECK ADD FOREIGN KEY([ApplicationId])
REFERENCES [dbo].[aspnet_Applications] ([ApplicationId])
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Us__Appli__75AD65ED]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_Users]'))
ALTER TABLE [dbo].[aspnet_Users]  WITH CHECK ADD FOREIGN KEY([ApplicationId])
REFERENCES [dbo].[aspnet_Applications] ([ApplicationId])
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Me__Appli__7E42ABEE]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_Membership]'))
ALTER TABLE [dbo].[aspnet_Membership]  WITH CHECK ADD FOREIGN KEY([ApplicationId])
REFERENCES [dbo].[aspnet_Applications] ([ApplicationId])
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Me__UserI__7F36D027]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_Membership]'))
ALTER TABLE [dbo].[aspnet_Membership]  WITH CHECK ADD FOREIGN KEY([UserId])
REFERENCES [dbo].[aspnet_Users] ([UserId])
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Pe__PathI__002AF460]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_PersonalizationAllUsers]'))
ALTER TABLE [dbo].[aspnet_PersonalizationAllUsers]  WITH CHECK ADD FOREIGN KEY([PathId])
REFERENCES [dbo].[aspnet_Paths] ([PathId])
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Pe__PathI__7B663F43]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_PersonalizationPerUser]'))
ALTER TABLE [dbo].[aspnet_PersonalizationPerUser]  WITH CHECK ADD FOREIGN KEY([PathId])
REFERENCES [dbo].[aspnet_Paths] ([PathId])
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Pe__UserI__7C5A637C]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_PersonalizationPerUser]'))
ALTER TABLE [dbo].[aspnet_PersonalizationPerUser]  WITH CHECK ADD FOREIGN KEY([UserId])
REFERENCES [dbo].[aspnet_Users] ([UserId])
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Us__RoleI__797DF6D1]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_UsersInRoles]'))
ALTER TABLE [dbo].[aspnet_UsersInRoles]  WITH CHECK ADD FOREIGN KEY([RoleId])
REFERENCES [dbo].[aspnet_Roles] ([RoleId])
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Us__UserI__7A721B0A]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_UsersInRoles]'))
ALTER TABLE [dbo].[aspnet_UsersInRoles]  WITH CHECK ADD FOREIGN KEY([UserId])
REFERENCES [dbo].[aspnet_Users] ([UserId])
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_dvent_Crop_aspnet_Users]') AND parent_object_id = OBJECT_ID(N'[dbo].[dvent_Preset]'))
ALTER TABLE [dbo].[dvent_Preset]  WITH CHECK ADD  CONSTRAINT [FK_dvent_Crop_aspnet_Users] FOREIGN KEY([UserID])
REFERENCES [dbo].[aspnet_Users] ([UserId])
GO
ALTER TABLE [dbo].[dvent_Preset] CHECK CONSTRAINT [FK_dvent_Crop_aspnet_Users]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK__aspnet_Pr__UserI__7D4E87B5]') AND parent_object_id = OBJECT_ID(N'[dbo].[aspnet_Profile]'))
...
INSERT INTO [dvent_web].[dbo].[dvent_Preset]
     ...
     VALUES
           ('Corn'
           , 10, 10, 10, 10, 10, 10, 10, 10, GETDATE(), GETDATE()
           , null
           , 1)
GO
...
INSERT INTO [dvent_web].[dbo].[dvent_Preset]
     ...
     VALUES
           ('Starfruit'
           , 82, 10, 5, 5, 80, 5, 30, 25, GETDATE(), GETDATE()
           , null
           , 1)
GO
...
INSERT INTO [dvent_web].[dbo].[dvent_Preset]
     ...
     VALUES
           ('Banana'
           , 78, 10, 5, 5, 85, 10, 25, 60, GETDATE(), GETDATE()
           , null
           , 1)
GO
...
INSERT INTO [dvent_web].[dbo].[dvent_Preset]
     ...
     VALUES
           ('Rutabaga'
           , 70, 10, 5, 5, 50, 10, 50, 25, GETDATE(), GETDATE()
           , null
           , 1)
GO
...
INSERT INTO [dvent_web].[dbo].[dvent_Preset]
     ...
     VALUES
           ('Peas'
           , 82, 90, 5, 10, 30, 50, 60, 75, GETDATE(), GETDATE()
           , null
           , 1)
GO
...
INSERT INTO [dvent_web].[dbo].[dvent_Preset]
     ...
     VALUES
           ('Carrot'
           , 80, 100, 5, 20, 25, 50, 45, 60, GETDATE(), GETDATE()
           , null
           , 1)
GO
...
INSERT INTO [dvent_web].[dbo].[dvent_Preset]
     ...
     VALUES
           ('Potato'
           , 80, 85, 8, 15, 25, 50, 35, 50, GETDATE(), GETDATE()
           , null
           , 1)
GO
...
INSERT INTO [dvent_web].[dbo].[dvent_Preset]
     ...
     VALUES
           ('Celery'
           , 80, 87, 8, 15, 25, 50, 25, 50, GETDATE(), GETDATE()
           , null
           , 1)
GO
...
INSERT INTO [dvent_web].[dbo].[dvent_Preset]
     ...
     VALUES
           ('Cucumber'
           , 75, 82, 5, 10, 25, 50, 25, 50, GETDATE(), GETDATE()
           , null
           , 1)
GO
